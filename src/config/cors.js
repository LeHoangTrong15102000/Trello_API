...
export const corsOptions = {
  origin: function (origin, callback) {
    ...
    if (env.BUILD_MODE === 'dev') {
      // Nếu môi trường là dev thì mình cho qua luôn không chặn lại
      return callback(null, true) // Lỗi là null và cho phép pass qua
    }
    ...
    // Có thể sử dụng WHITELIST_DOMAINS.indexOf(origin)
